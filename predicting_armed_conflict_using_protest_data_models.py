# Predicting armed conflict using protest data - data and model management
...
def FetchData(run_id):
    ...
    if run_id == 'protest_paper_incidence_01':
        # Baseline models
        Datasets.append(
            FetchTable((Queryset("protest_paper_old_baseline_incidence", "priogrid_month")), 'baseline_simple'))
        ...
        # Baseline + Political institutions models (I, II, III, IV)
        ...
        # Baseline + Political institutions models (III, IV) + economic development models
        Datasets.append(
            FetchTable((Queryset("protest_paper_elect_econ_national_bl", "priogrid_month")), 'elect_econ_nat_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_elect_econ_full_bl", "priogrid_month")), 'elect_econ_full_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_devi_econ_national_bl", "priogrid_month")), 'devi_econ_nat_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_devi_econ_full_bl", "priogrid_month")), 'devi_econ_full_bl'))
        # Baseline + Protest models
        Datasets.append(FetchTable((Queryset("protest_paper_pr_naive_bl", "priogrid_month")), 'pr_naive_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_dynamic_local_bl", "priogrid_month")), 'pr_dynamic_loc_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_dynamic_national_bl", "priogrid_month")), 'pr_dynamic_nat_bl'))
        # Baseline + Full protest model + political institutions models (I, II, III, IV)
    ...
    if run_id == 'protest_paper_incidence_02':
        # Baseline + Full protest model + economic development models
        ...
        # Baseline + Full protest model + political institutions (III, IV) + economic development models
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_elect_econ_national_bl", "priogrid_month")), 'pr_elect_econ_nat_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_elect_econ_full_bl", "priogrid_month")), 'pr_elect_econ_full_bl'))

        return (Datasets)

    if run_id == 'protest_paper_incidence_03_01':
        ...
        Datasets.append(FetchTable((Queryset("protest_paper_pr_devi_econ_national_bl_01", "priogrid_month")),
                                   'pr_devi_econ_nat_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_devi_econ_full_bl_01", "priogrid_month")), 'pr_devi_econ_full_bl'))

        return (Datasets)

    if run_id == 'protest_paper_incidence_03_02':
        # Tables with more than 50 variables.
        Datasets.append(FetchTable((Queryset("protest_paper_pr_devi_bl_02", "priogrid_month")), 'pr_devi_bl'))
        Datasets.append(FetchTable((Queryset("protest_paper_pr_devi_econ_national_bl_02", "priogrid_month")),
                                   'pr_devi_econ_nat_bl'))
        Datasets.append(
            FetchTable((Queryset("protest_paper_pr_devi_econ_full_bl_02", "priogrid_month")), 'pr_devi_econ_full_bl'))
...
def fetch_gdf():
    ...
    gdf_master = pd.DataFrame(
        gdf_master.rename(columns={'geom': 'geometry', 'pg_id': 'priogrid_gid'}).set_index('priogrid_gid')['geometry'])
